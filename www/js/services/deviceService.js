appControllers.service('deviceService1',function($http,$ionicPopup,$rootScope,$cordovaNetwork,$cordovaGeolocation,$cordovaLaunchNavigator,$ionicLoading,$cordovaDevice
  ){
...
//
  ...
  this.getLocationInformation = function(position,callback){
    ...
    var urlLocationInfo="https://maps.googleapis.com/maps/api/geocode/json?language=th&latlng="+
      position.latitude+","+position.longitude+"&sensor=false&key=AIzaSyCZDic_rNipmZn_pMbc7wpuH6JgBlikbqM";
